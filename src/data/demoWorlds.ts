...
export const demoWorlds: DemoWorld[] = [
  ...
  },
  {
    ...
    iconLabel: '⚖️',
    status: 'locked',
    description: 'Explore wordplay, retell texts, and compare important details across genres.',
    progressionLabel: 'Compare Castle quests are being prepared.',
    skills: ['similes', 'idioms', 'alliteration', 'retelling', 'comparison'],
    currentProgress: 0,
    units: [...buildSequentialWorldUnitShells('compare-castle')],
  },
  {
    id: 'evidence-arena',
    name: 'Evidence Arena',
