...
export const grade2WordForgeFluencyPracticeLessons: ContentPackLesson[] = [
  {
    ...
    fluencyPracticeBlock: fluencyBlock({
      ...
      phraseGroups: [
        ...
        phrase('weather-phrase-6', '"Will the wind move gently?"', 'Let your voice rise for the question.'),
  ...
  },
  {
    ...
    fluencyPracticeBlock: fluencyBlock({
      ...
      phraseGroups: [
        ...
        phrase('science-phrase-7', 'Another student helped the class', 'Keep the helpful action together.'),
        phrase('science-phrase-8', 'review the steps.', 'Stop at the period.'),
      ],
      expressionCues: [
        ...
        expressionCue('science-cue-dialogue', 'science-4', 'Helpful action cue', 'Read the final helpful action in a steady voice.'),
      ],
      requiredReadCount: 2,
      practiceMode: 'guided',
    }),
