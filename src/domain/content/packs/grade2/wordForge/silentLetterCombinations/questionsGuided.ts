...
export const guidedQuestions: ReadingQuestion[] = [
  ...
  makeQuestion({
    ...
    prompt: 'Tap the word that completes the action meaning "look through the list."',
    explanation: 'Thumb completes the phrase thumb through, which means to look through the list.',
    evidenceReference: 'silent-letter-combinations-4-s2',
