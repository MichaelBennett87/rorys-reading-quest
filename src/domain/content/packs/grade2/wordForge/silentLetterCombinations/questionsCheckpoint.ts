...
export const checkpointQuestions: ReadingQuestion[] = [
  ...
  makeQuestion({
    ...
    prompt: 'Which word in the shelter passage ends with quiet mb and names a tool?',
    explanation: 'Comb names a tool, ends with quiet mb, and has the m sound at the end.',
  ...
  makeQuestion({
    ...
    prompt: 'Choose all the words that have a quiet letter pattern.',
  ...
  makeQuestion({
    ...
    targetVocabulary: ['kneel', 'wrap', 'comb', 'ghost', 'island'],
    soundOutChunks: ['kn', 'eel', 'wr', 'ap', 'co', 'mb', 'gh', 'ost', 'is', 'land'],
    tags: ['silent-kn', 'silent-wr', 'silent-mb', 'silent-gh', 'silent-s-island'],
    rows: [
      {
        id: 'knight-row',
  ...
  makeQuestion({
    ...
    prompt: 'Which word in the workshop passage begins with quiet kn and names an action?',
  ...
  makeQuestion({
    ...
    prompt: 'Which word in the shelter passage ends with quiet mb and shows movement up the ramp?',
    explanation: 'Climb ends with quiet mb, and we hear m at the end.',
    evidenceReference: 'silent-letter-combinations-4-s2',
    evidenceReferenceIds: ['climb-choice'],
    targetVocabulary: ['lamb', 'comb', 'thumb', 'climb'],
  ...
  makeQuestion({
    ...
    prompt: 'Match each word from the final review set to its silent-letter family.',
    explanation: 'Each word belongs to one of the reviewed silent-letter families.',
    evidenceReference: 'silent-letter-combinations-7-s1',
