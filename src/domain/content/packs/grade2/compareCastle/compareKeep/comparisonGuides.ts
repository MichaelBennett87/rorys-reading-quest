...
export const compareKeepComparisonGuides: readonly PairedTextComparisonGuide[] = [
  ...
  },
  {
    ...
    relationshipKind: 'same-theme',
    sharedTopicOrThemeStatement: 'Both texts show helpers following a plan that helps a group get ready to move forward.',
    importantSimilarities: [
      point(
        'ck-guide-5-sim-1',
        'character',
  ...
  },
  {
    ...
    relationshipKind: 'same-topic',
    sharedTopicOrThemeStatement: 'Both texts explain how plant roots support plants and help soil stay in place.',
    importantSimilarities: [
      point(
        'ck-guide-6-sim-1',
        'central-idea',
        'Both texts explain that roots support plants and the soil around them.',
        [createScopedEvidenceReference(f1, 'ck-info-5-s2'), createScopedEvidenceReference(f1, 'ck-info-5-s6')],
        [createScopedEvidenceReference(f2, 'ck-info-6-s2'), createScopedEvidenceReference(f2, 'ck-info-6-s6')],
        'The central idea matters because it states what both root texts are mostly about.',
      ),
      point(
        'ck-guide-6-sim-2',
        'important-detail',
        'Both texts explain that roots help soil stay in place instead of washing or drifting away.',
        ...
        'This detail matters because holding soil is the important process shared by both texts.',
      ),
      point(
        'ck-guide-6-sim-3',
        'process',
        'Both texts describe roots spreading through soil.',
        [createScopedEvidenceReference(f1, 'ck-info-5-s2'), createScopedEvidenceReference(f1, 'ck-info-5-s4')],
        [createScopedEvidenceReference(f2, 'ck-info-6-s1')],
        'The process matters because it explains how roots do their work in both places.',
      ),
    ],
    importantDifferences: [
      point(
        'ck-guide-6-diff-1',
        'important-detail',
        'Text 1 focuses on roots at a wet pond edge, while Text 2 focuses on roots in a garden bed.',
        [createScopedEvidenceReference(f1, 'ck-info-5-s2')],
        [createScopedEvidenceReference(f2, 'ck-info-6-s1'), createScopedEvidenceReference(f2, 'ck-info-6-s6')],
        'The setting difference matters because roots support soil in two different places.',
      ),
      point(
        'ck-guide-6-diff-2',
        'process',
        'Text 1 explains moving pond water, while Text 2 explains what can happen after heavy rain.',
        [createScopedEvidenceReference(f1, 'ck-info-5-s4'), createScopedEvidenceReference(f1, 'ck-info-5-s5')],
        [createScopedEvidenceReference(f2, 'ck-info-6-s3'), createScopedEvidenceReference(f2, 'ck-info-6-s4')],
        'The process difference matters because each text gives a different cause for soil moving.',
      ),
      point(
        'ck-guide-6-diff-3',
        'setting',
        'Text 1 says the plants shelter small animals, while Text 2 says roots gather water for the plant.',
        [createScopedEvidenceReference(f1, 'ck-info-5-s3')],
        [createScopedEvidenceReference(f2, 'ck-info-6-s2')],
        'The detail difference matters because each text adds a different way roots and plants help living things.',
      ),
    ],
    text1OtherDetailIds: [createScopedEvidenceReference(f1, 'ck-info-5-s1')],
    text2OtherDetailIds: [createScopedEvidenceReference(f2, 'ck-info-6-s5')],
    reviewStatus: 'DRAFT',
    contentVersion: COMPARE_KEEP_CONTENT_VERSION,
  },
  {
