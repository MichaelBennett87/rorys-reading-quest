...
const unpackSupplyCartPlan: PassagePlan = {
  ...
  sentences: [
    ...
    { sentenceId: contextCavernMorphologyMineSentenceIds.unpackSupplyCart[4], text: 'The cart looked empty after the unpacking was done.' },
...
const preheatSnackDemoPlan: PassagePlan = {
  ...
  sentences: [
    ...
    { sentenceId: contextCavernMorphologyMineSentenceIds.preheatSnackDemo[2], text: 'Two students began to disagree about which tray should go first.' },
    { sentenceId: contextCavernMorphologyMineSentenceIds.preheatSnackDemo[3], text: 'A helpful student covered the warm pan.' },
    ...
    { sentenceId: contextCavernMorphologyMineSentenceIds.preheatSnackDemo[6], text: 'Another helper helped check the steps.' },
...
const kitchenCrewPracticePlan: PassagePlan = {
  ...
  sentences: [
    ...
    { sentenceId: contextCavernMorphologyMineSentenceIds.kitchenCrewPractice[3], text: 'Two students began to disagree about where the markers should go.' },
    ...
    { sentenceId: contextCavernMorphologyMineSentenceIds.kitchenCrewPractice[7], text: 'The cart looked orderly again.' },
  ],
  targetPlans: [
    { word: 'unpack', sentenceIndex: 0 },
...
const readingTableResetPlan: PassagePlan = {
  ...
  sentences: [
    ...
    { sentenceId: contextCavernMorphologyMineSentenceIds.readingTableReset[2], text: 'Tongs helped the class place the cookies on the tray.' },
