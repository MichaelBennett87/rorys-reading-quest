...
function buildFiveQuestionLesson(
  ...
  return [
    mc({
      ...
      explanation: `${a.characterName} sees the situation this way because the story shows ${a.perspectiveStatement.toLowerCase()}.`,
    ...
    mc({
      ...
      explanation: `${b.characterName} sees the situation this way because the story shows ${b.perspectiveStatement.toLowerCase()}.`,
    ...
    ms({
      ...
      explanation: `These details show why ${a.characterName} thinks the situation needs ${a.perspectiveStatement.toLowerCase()}.`,
  ...
  return [
    ...
    mc({
      ...
      choices: [
        ...
        { id: 'choice-b', text: `${a.characterName} thinks ${a.perspectiveStatement.toLowerCase()} and ${b.characterName} thinks ${b.perspectiveStatement.toLowerCase()}.` },
