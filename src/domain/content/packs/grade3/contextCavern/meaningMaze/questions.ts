...
const figurativeQuestions: ReadingQuestion[] = [
  ...
  multi(contexts.figurative, 3, 'Choose two clues showing that time slipped away means time passed quickly. Select two.', ['The sun moved low.', 'The final loop was still unfinished.', 'The group opened its map in the morning.', 'The bridge board had washed away.'], [0, 1], 'The low sun and unfinished work show that the available day passed.', [10, 11, 12], ['time slipped away'], ['figurative-context']),
  hot(contexts.figurative, 4, 'Select the line that confirms the idea was accepted and developed by the group.', [5, 6, 7, 9], 2, 'The plan begins to grow after everyone adds a step, confirming the figurative phrase.', ['the idea took root'], ['context-confirmation']),
