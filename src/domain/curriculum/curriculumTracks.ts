...
const curriculumTrackDefinitions: CurriculumTrackDefinition[] = [
  {
    ...
    curriculumOrder: 110, worldChapterOrder: 1, initialDifficulty: 1, initialLastMasteredDifficulty: 0,
  ...
  },
  {
    ...
    entryUnitId: 'pp-unit-1', unitIds: ['pp-unit-1'], curriculumOrder: 50, worldChapterOrder: 1,
  ...
  },
  {
    ...
    unitIds: ['id-unit-1', 'id-unit-2', 'id-unit-3', 'id-unit-4'], curriculumOrder: 20, worldChapterOrder: 1,
  ...
  },
  {
    ...
    curriculumOrder: 90, worldChapterOrder: 1, initialDifficulty: 1, initialLastMasteredDifficulty: 0,
  ...
  },
  {
    ...
    entryUnitId: 'cg-unit-1', unitIds: ['cg-unit-1', 'cg-unit-2', 'cg-unit-3'], curriculumOrder: 70,
  ...
  },
  {
    ...
    curriculumOrder: 30, worldChapterOrder: 2, initialDifficulty: 1, initialLastMasteredDifficulty: 0,
  ...
  },
  {
    ...
    entryUnitId: 'g3-pp-unit-1', unitIds: ['g3-pp-unit-1'], curriculumOrder: 60, worldChapterOrder: 2,
  ...
  },
  {
    ...
    curriculumOrder: 40, worldChapterOrder: 2, initialDifficulty: 1, initialLastMasteredDifficulty: 0,
  ...
  },
  {
    ...
    curriculumOrder: 100, worldChapterOrder: 2, initialDifficulty: 1, initialLastMasteredDifficulty: 0,
  ...
  },
  {
    ...
    curriculumOrder: 80, worldChapterOrder: 2, initialDifficulty: 1, initialLastMasteredDifficulty: 0,
...
export const curriculumTracks: readonly CurriculumTrackDefinition[] = Object.freeze(
  [...curriculumTrackDefinitions]
    .sort((left, right) => left.curriculumOrder - right.curriculumOrder || left.skillId.localeCompare(right.skillId))
