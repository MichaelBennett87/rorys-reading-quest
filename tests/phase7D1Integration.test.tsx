...
describe('Phase 7D1 integration and reconciled one-button journey', () => {
  test('registers only Figurative Fortress and derives the Grade 3 coverage snapshot', () => {
    ...
    expect(getActiveContentRegistryTotals()).toEqual({ activePackCount: 35, activeLessonCount: 245, activePassageCount: 252, activeQuestionCount: 1409, activeSupportTargetCount: 971 })
