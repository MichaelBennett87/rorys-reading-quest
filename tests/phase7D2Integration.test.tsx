...
describe('Phase 7D2 integration and reconciled one-button journey', () => {
  test('registers only Summary Stronghold and derives complete ELA.3.R.3.2 coverage', () => {
    ...
    expect(getActiveContentRegistryTotals()).toEqual({ activePackCount: 36, activeLessonCount: 252, activePassageCount: 259, activeQuestionCount: 1450, activeSupportTargetCount: 999 })
