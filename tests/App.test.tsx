...
describe('Phase 2 lesson flow and child shell', () => {
  ...
  test('shows Quiet Letter Quest as a locked preview at difficulty 7', async () => {
    ...
    expect(screen.getByText(/Ready when you are\. Start the quest to begin\./i)).toBeTruthy()
  ...
  test('can answer one question and remain child-safe', () => {
    ...
    expect(screen.getByText(/Leaf has the ea sound like clean/i)).toBeTruthy()
  ...
  test('shows accessible reward and progress labels', () => {
    ...
    expect(screen.getByLabelText(/0 experience points/i)).toBeTruthy()
    expect(screen.getByLabelText(/0 stars earned/i)).toBeTruthy()
