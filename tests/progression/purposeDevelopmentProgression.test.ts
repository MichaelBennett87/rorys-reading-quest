...
describe('Purpose Development Path progression', () => {
  ...
  test('requires two distinct strong checkpoints and advances into Claim and Evidence Court', () => {
    ...
    expect(second.nextQuest).toMatchObject({ status: 'available', lesson: { unitId: 'g3-id-unit-4', difficulty: 4 } })
  })
