...
describe('Suffix Shifter progression and review isolation', () => {
  ...
  test('requires two distinct independent checkpoints and opens Multisyllable Mountain', () => {
    ...
    expect(second.nextQuest).toMatchObject({ status: 'available', purpose: 'progression', lesson: { unitId: 'g3-wg-unit-3', difficulty: 3 } })
  })
