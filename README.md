...
- Status: `Phase 6C complete; Phase 6D1 and Phase 6D2 complete; Phase 6 remains in progress`.
...
- Content: ten registered Grade 2 bridge packs with 70 DRAFT lessons, 70 original DRAFT passages, 384 DRAFT questions, and 271 DRAFT word-support targets, plus legacy lessons preserved for recovery and history.
