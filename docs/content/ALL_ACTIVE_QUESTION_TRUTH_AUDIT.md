...
## Phase 7D2 registration

Summary Stronghold adds 41 independently reviewed questions under `g3-compare-castle-summary-stronghold`. The production inventory now contains 1,450 active questions and 1,450 current PASS ledger records across 36 packs. The executable contract accepts 1,450 canonical submissions and 486 canonical-equivalent submissions, rejects 17,781 adversarial submissions, and completes 22,617 grading assertions. Registration review corrected one source-ownership defect in a Word Help target by replacing a model-summary-only word with learner-visible `strengthen`. No source text, summary guide, scored question, key, distractor, explanation, evidence reference, evaluator, unresolved question ID, or stale fingerprint remains defective. These are repository truth-gate results, not teacher approval, learner mastery, or FAST certification.
