...
Phase 6F2 will cover `ELA.2.R.3.2` with structured authored retell choices for literary and informational retelling.
Phase 6F3 will cover `ELA.2.R.3.3` with paired-text comparison of important details.
