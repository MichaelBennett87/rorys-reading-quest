...
Phase 6D0 adds only the multi-world and multi-skill progression foundation needed for later prose and poetry packs. Phase 6D1 adds the first prose pack. It does not add new poetry or informational content yet.
