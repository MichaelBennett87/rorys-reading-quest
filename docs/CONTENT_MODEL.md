...
## Phase 7 historical content model and current bounded correction

At the Phase 7 completion checkpoint, the active registry contained 40 packs, 280 lessons, 294 texts, 1,614 questions, and 1,111 support targets; Grade 2 contained 889 questions and Grade 3 contained 725. The post-Phase-7 comprehension-first correction keeps every pack, lesson, text, support target, benchmark, track, and unit, but retires one old seventh question from each of the three materially rewritten Story Map checkpoints. Current totals are 40 packs, 280 lessons, 294 texts, 1,611 questions, and 1,111 support targets: Grade 2 has 22 packs, 154 lessons, 161 texts, 886 questions, and 614 support targets; Grade 3 remains 18 packs, 126 lessons, 133 texts, 725 questions, and 497 support targets. Every current active question has one current PASS truth and semantic record.
...
The optional `deferredWordStudySession` is one bounded `ActiveLessonSession`, not curriculum storage or an archive. It is validated and cloned through the same schema-v1 contracts as the active slot. It preserves only IDs, response mappings, question position, assistance events, fluency state, timestamps, fingerprint, and launch context already allowed for active recovery.
