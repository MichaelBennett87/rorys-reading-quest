...
| `ELA.2.R.1.2` | Story Scouts | `ss-unit-2` | Theme Trail | 1-2 | 6D2 | planned |
...
- `ELA.2.R.1.1` is implemented in DRAFT across the Story Map pack; `ELA.2.R.1.2`, `ELA.2.R.1.3`, and `ELA.2.R.1.4` remain planned.
