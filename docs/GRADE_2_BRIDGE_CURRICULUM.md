...
- Compare Castle roadmap units: `cg-unit-1` Wordplay Watchtower, `cg-unit-2` Retell Hall, and `cg-unit-3` Compare Keep. Phase 6F1 activates Wordplay Watchtower, Phase 6F2 activates Retell Hall, and Phase 6F3 activates Compare Keep while Phase 6F4 remains the final audit boundary.
