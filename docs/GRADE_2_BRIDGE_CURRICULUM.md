...
This roadmap describes the bounded Grade 2 bridge plan for Rory's Reading Quest. Phase 6A1, Phase 6A2, and Phase 6B1 provide authored DRAFT coverage for the listed Grade 2 bridge patterns, not complete Grade 2 instruction, and they keep all new material DRAFT-only.
...
| `ELA.2.F.1.3c` | Word Forge | `wg-unit-2` | `ELA.2.F.1.3b` | 2-4 | 6B1-6B2 | partial |
...
| Benchmark | Planned world | Planned unit | Prerequisite | Intended difficulty range | Phase | Status |
| --- | --- | --- | --- | --- | --- | --- |
| `ELA.2.R.1.1` | Story Lab | `sl-unit-1` | Bridge decoding support | 1-2 | 6D | planned |
| `ELA.2.R.1.2` | Story Lab | `sl-unit-2` | `ELA.2.R.1.1` | 1-2 | 6D | planned |
| `ELA.2.R.1.3` | Story Lab | `sl-unit-3` | `ELA.2.R.1.1` | 1-2 | 6D | planned |
| `ELA.2.R.1.4` | Story Lab | `sl-unit-4` | `ELA.2.R.1.2` | 1-2 | 6D | planned |
...
- `ELA.2.F.1.3c` is partial in DRAFT in Phase 6B1 and remains incomplete until Phase 6B2 adds consonant-le.
