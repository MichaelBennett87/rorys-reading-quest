...
| `ELA.2.R.1.4` | Poetry Planet | `pp-unit-1` | Rhyme Routes | 0-1 | 6D4 | implemented |
...
| `ELA.2.R.2.4` | Information Detectives | `id-unit-4` Opinion & Evidence Desk | `ELA.2.R.2.3` | 3-4 | 6E4 | implemented |
...
| `ELA.2.R.3.2` | Compare Castle | `cg-unit-2` | `ELA.2.R.3.1` | 1-2 | 6F2 | implemented |
| `ELA.2.R.3.3` | Compare Castle | `cg-unit-3` | `ELA.2.R.3.2` | 2-3 | 6F3 | implemented |
| `ELA.2.V.1.1` | Context Cavern | `cc-unit-1` | Academic Word Workshop | 0-1 | 6E5 | implemented |
| `ELA.2.V.1.2` | Context Cavern | `cc-unit-2` | `ELA.2.V.1.1` | 1-2 | 6E6 | implemented |
| `ELA.2.V.1.3` | Context Cavern | `cc-unit-3` | `ELA.2.V.1.2` | 2-3 | 6E7 | implemented |
...
- Phase 6E4 activates `ELA.2.R.2.4` through Information Detectives Opinion & Evidence Desk while Context Cavern remains planned.
...
- Phase 6F0 kept Compare Castle roadmap-only until Wordplay Watchtower became active in Phase 6F1, Phase 6F2 adds Retell Hall with structured authored retell choices rather than spontaneous oral retelling or open-ended writing, and Phase 6F3 adds Compare Keep with structured authored paired-text comparison choices rather than original written or oral comparison.
- Compare Castle roadmap units: `cg-unit-1` Wordplay Watchtower, `cg-unit-2` Retell Hall, and `cg-unit-3` Compare Keep. Phase 6F1 activates Wordplay Watchtower, Phase 6F2 activates Retell Hall, and Phase 6F3 activates Compare Keep while Phase 6F4 completes the final audit boundary and Phase 6 completion.
