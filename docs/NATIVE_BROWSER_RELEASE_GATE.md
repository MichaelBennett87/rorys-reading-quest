...
12. The parent-enabled Read & Write pilot remains request-free while disabled; local ink survives a real browser-process restart; unavailable processing falls back to parent review; mocked protected transcription/evaluation stays bounded and separate from reading rewards; and parent correction/deletion works. Synthetic pointer events and mocked provider output are not evidence of physical-stylus performance or live-provider accuracy.
